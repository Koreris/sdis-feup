...
{	
	...
	{	
		 ...
		 System.out.println("Connecting to host: "+InetAddress.getByName(argComponents[2]).getHostAddress());
	
		 final Registry registry = LocateRegistry.getRegistry(InetAddress.getByName(argComponents[2]).getHostAddress(), 1098);
